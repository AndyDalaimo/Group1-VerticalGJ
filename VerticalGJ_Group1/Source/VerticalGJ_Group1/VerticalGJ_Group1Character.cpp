...
AVerticalGJ_Group1Character::AVerticalGJ_Group1Character() : GetRotated(false), ProjectileUpgrade(false)
{
...
void AVerticalGJ_Group1Character::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AVerticalGJ_Group1Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AVerticalGJ_Group1Character::Move);
...
void AVerticalGJ_Group1Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AVerticalGJ_Group1Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
